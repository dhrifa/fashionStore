...
val itemGreen = ColorItem(
    _item = "Sbm T-Shirt",
    _color = cardColorGreen,
    _colorTitle = "Green",
    _image = "https://http.cat/100"
)
val itemBlue = ColorItem(
    _item = "Sbm T-Shirt",
    _color = cardColorBlue,
    _colorTitle = "Blue",
    _image = "https://http.cat/101"
)
val itemPeach = ColorItem(
    _item = "Sbm T-Shirt",
    _color = cardColorPeach,
    _colorTitle = "Modern Peach",
    _image = ""
)
val itemYellow = ColorItem(
    _item = "Sbm T-Shirt",
    _color = cardColorYellow,
    _colorTitle = "Yellow",
    _image = "https://http.cat/103"
)
